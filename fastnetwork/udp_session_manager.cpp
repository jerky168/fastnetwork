...
shared_ptr<io_session> fastnetwork::udp::udp_session_manager::new_session( shared_ptr<ip::udp::socket> socket, endpoint remote )
{
...
void fastnetwork::udp::udp_session_manager::check_session_idle()
{
...
void fastnetwork::udp::udp_session_manager::close_session( shared_ptr<io_session> session )
{
	mutex::scoped_lock	lock(mutex_);
	sessions_.erase( session->get_remote_endpoint() );
}

void fastnetwork::udp::udp_session_manager::find_idle_sessions( session_map &idle_sessions )
{
	mutex::scoped_lock	lock(mutex_);

...
namespace fastnetwork {
	...
	public:
		//************************************
		// Method:    set_handler
		// FullName:  fastnetwork::io_session::set_handler
		...
		//************************************
		// Method:    get_handler
		// FullName:  fastnetwork::io_session::get_handler
		// Access:    virtual public 
		...
		// FullName:  fastnetwork::io_session::get_filter_chain
		// Access:    virtual public 
		...
		// FullName:  fastnetwork::io_session::write
		// Access:    virtual public 
		// Returns:   void
		// Qualifier:
		...
		// FullName:  fastnetwork::io_session::close
		// Access:    virtual public 
		// Returns:   void
		// Qualifier:
		//************************************
		...
		// FullName:  fastnetwork::io_session::handle_write_complete
		// Access:    virtual public 
		// Returns:   void
		// Qualifier:
		...
		// FullName:  fastnetwork::io_session::set_attribute
		// Access:    virtual public 
		// Returns:   void
		// Qualifier:
		...
		// FullName:  fastnetwork::io_session::get_attribute
		// Access:    virtual public 
		// Returns:   boost::any
		// Qualifier:
		// Parameter: const string & key
		...
		// FullName:  fastnetwork::io_session::remove_attribute
		// Access:    virtual public 
		// Returns:   void
		// Qualifier:
		// Parameter: const string & key
		...
		//************************************
		// Method:    is_connected
		// FullName:  fastnetwork::io_session::is_connected
		// Access:    virtual public 
		// Returns:   bool
		// Qualifier:
		//************************************
		...
		//************************************
		// Method:    connected
		// FullName:  fastnetwork::io_session::connected
		// Access:    virtual public 
		// Returns:   void
		// Qualifier:
		//************************************
		...
		//************************************
		// Method:    is_idle
		// FullName:  fastnetwork::io_session::is_idle
		// Access:    virtual public 
		// Returns:   bool
		// Qualifier:
		//************************************
